...
//Yuanguo: awsSigV2 has no use except to make a different constructor;  
S3Client::S3Client(const Client::ClientConfiguration& clientConfiguration, int awsSigV2) :
  BASECLASS(clientConfiguration,
    ...
    m_executor(clientConfiguration.executor), m_useVirtualAdressing(false)
{
  AWS_UNREFERENCED_PARAM(awsSigV2);

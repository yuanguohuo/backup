...
public:
    ...
    {
#if ENABLE_BCRYPT_ENCRYPTION
#error("Yuanguo: For Sha1HMAC, there is only openssl implementation, no bcrypt")
#elif ENABLE_OPENSSL_ENCRYPTION
        return Aws::MakeShared<Sha1HMACOpenSSLImpl>(s_allocationTag);
#elif ENABLE_COMMONCRYPTO_ENCRYPTION
#error("Yuanguo: For Sha1HMAC, there is only openssl implementation, no common crypto")
#else
    return nullptr;
#endif
    }

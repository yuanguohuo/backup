...
namespace Aws
{
    ...
    namespace Auth
    {
        ...
        //Yuanguo: implemente AWS Signatrue V2 and the dependent Sha1HMAC;
        static const char DEFAULT_AUTHV2_SIGNER[] = "DefaultAuthV2Signer";
    ...
    namespace Client
    {
        ...
        public:
            ...
            Aws::String GetName() const override { return Aws::Auth::DEFAULT_AUTHV2_SIGNER; }
        ...
        private:
            Aws::Utils::ByteBuffer hmac_sh1(const Aws::Utils::ByteBuffer& stringToSign,  const Aws::Utils::ByteBuffer & secretKey) const;

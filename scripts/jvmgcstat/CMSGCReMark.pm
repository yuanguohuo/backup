...
sub new
{
  ...
  croak "CMSGCReMark::new() is a class-function thus the 1st param should be the class name" if ref $className;
...
{
  my $self = shift @_;
  croak "CMSGCReMark::dump() is an object-function thus the 1st param should be the object" unless ref $self;
